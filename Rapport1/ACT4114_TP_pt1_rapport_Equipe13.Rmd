...
Pour commercer, les variables suivantes ne doivent pas être utilisées pour modéliser la fréquence d'accident de la couverture étudiée () :
...
```{r Group1, echo=FALSE, message=FALSE, warning=FALSE, fig.cap="Moyenne de réclamation par Bonus", fig.width=10, fig.height=6}
