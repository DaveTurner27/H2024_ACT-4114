...
2.  Faire les prévisions sur chaque observation de l'échantillon de validation, et ce, avec toutes les valeurs de $k$ testées. 
Note : on utilise un léger biais de 1E-4 pour éviter les prévisions de 0.
