...
Le modèle comporte un seul hyperparamètre, soit le $k$ qui représente le nombre de voisins utilisés pour calculer les prévisions. 
Pour ce faire, on utilise la procédure suivante :

1.  Créer un échantillon de validation de manière aléatoire avec 30 % des données de l'échantillon d'entrainement.
