...
\textsc{\LARGE Deuxième rapport}\\[1.0cm] % LAISSER TP OU METTRE UN VRAI TITRE
...
\HRule \\[0.4cm]
{ \Large \bfseries Modèle de fréquence}\\[0.20cm] { \huge \bfseries Modélisation}\\[0.20cm]
...
%%% MODIFIER ICI (DATE)%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\textsc{\large 21 avril 2024 }\\[1cm] % Date, change the \today to a set date if you want to be precise
